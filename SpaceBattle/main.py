...
def update(dt):
    ...
    if mode == "PLAYING" and music_playing == False:
        music.play("starwars")
...
def update_spaceship1(keyboard):
    ...
    elif keyboard.d and spaceShip1.x <= WIDTH//2:
        spaceShip1.x = spaceShip1.x + SPEED_X
...
def update_spaceship2(keyboard):
    if keyboard.up and spaceShip2.y >= 0:
        ...
        spaceShip2.y = spaceShip2.y + SPEED_Y
    elif keyboard.left and spaceShip2.x >= WIDTH//2 :
...
def detect_collisions():
    ...
    if life_player1 == 0:
        ...
        if explosion_played == False:
            ...
            clock.schedule(stop_sound_explosion, 2.0)
